  ...
  if (loading) {
    return (
      <AppShell active="batch">
        <div className="max-w-5xl mx-auto px-6 md:px-10 py-16 text-center text-ink-soft">Loading receipt…</div>
      </AppShell>
    );
  }
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <section className="lg:col-span-3">
            <div className="border border-hairline">
              <div className="px-5 py-4 border-b border-hairline flex items-center justify-between bg-surface-sunk">
